    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 py-3.5 border-b border-slate-200">
          ...
          />
          <kbd className="hidden sm:inline-block text-xs font-mono px-2 py-0.5 rounded bg-slate-100 text-slate-500 border border-slate-200">
            ESC
          </kbd>
        </div>
            ...
            filteredItems.map((item, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="hidden sm:inline shrink-0 text-[11px] font-medium text-slate-500 px-2 py-0.5 rounded bg-slate-100 border border-slate-200">
                    {item.category}
                  </span>
                </button>
              );
